/*
  ...
  - Added the required column `iv` to the `credit_card` table without a default value. This is not possible if the table is not empty.
...
CREATE UNIQUE INDEX "credit_card_iv_key" ON "credit_card"("iv");
